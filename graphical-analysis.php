...
if(isset($_SESSION['std_id'])){
	...
	if(isset($_GET['test_id'])&&isset($_GET['roll_no'])){
		...
		$main->display("pages/std-graphical-analysis.ta", $vars);
	}else{
		header("Location:./student-home.php?msg=Error! Test id not set, Please try again.&msg_clr=red");
		exit();
	}
	
}else{
		header("Location:./student-login.php?msg=Error! Session Expired, Please login again.&msg_clr=red");
		exit();
	}
?>