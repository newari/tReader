...
if(isset($_SESSION['std_id'])){
	...
	if(isset($_GET['test_id'])&&isset($_GET['roll_no'])){
		...
		$dbh->select("scaned_omrs", "test_data", "test_id='$test_id' AND std_roll_no='$roll_no'", "none", "1");
		if($dbh->sel_count_row>0){
	...
	header("Location:./student-login.php?msg=Session expired! Please login again&msg-clr=red");
	exit();
}
